...
public class ImageBannerWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "com.firmanjabar.submission4.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.firmanjabar.submission4.EXTRA_ITEM";
